...
/usr/bin/g++ -o libocamlinterface.so -rdynamic -shared -Wl,-rpath=/unsup/boost-1.55.0/amd64_rhel6/lib -Wl,-rpath=/home/turetsky/OCamlTest newton_interface.os -L/unsup/boost-1.55.0/amd64_rhel6/lib -L/home/turetsky/OCamlTest -lboost_filesystem -lboost_system -lboost_serialization -lrt || exit 1
