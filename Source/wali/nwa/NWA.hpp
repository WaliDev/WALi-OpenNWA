...
namespace wali
{
  namespace nwa
  {
    ...
    class NWA : public Printable
    {
       ...
       *
       */
      bool addInitialState( const St & state );
       ...
       *
       */
      bool removeInitialState( const St & state );
       ...
       *
       */
      bool addFinalState( const St & state );
       ...
       *
       */
      bool removeFinalState( const St & state );
       ...
       *
       */
      bool addCallTrans( const St & from, const Sym & sym, const St & to );
       ...
       *
       */
      bool removeCallTrans( const St & from, const Sym & sym, const St & to );
       ...
       *
       */
      bool addInternalTrans( const St & from, const Sym & sym, const St & to );
       ...
       *
       */
      bool removeInternalTrans( const St & from, const Sym & sym, const St & to );
       ...
       *
       */
      bool addReturnTrans( const St & from, const St & pred, const Sym & sym, const St & to );
       ...
       * TODO: write comments
       */
      bool removeReturnTrans( const St & from, const Sym & sym, const St & to );
       ...
       *
       */
      bool removeReturnTrans( const St & from, const St & pred,const Sym & sym, const St & to );
     ...
     */
    template <typename St,typename StName,typename Sym> 
    bool NWA<St,StName,Sym>::addState( const St & state )
    {
     ...
     */
    template <typename St,typename StName,typename Sym> 
    bool NWA<St,StName,Sym>::removeState( const St & state )
    {
     ...
     */
    template <typename St,typename StName,typename Sym> 
    bool NWA<St,StName,Sym>::addInitialState( const St & state )
    {
     ...
     */
    template <typename St,typename StName,typename Sym>
    bool NWA<St,StName,Sym>::removeInitialState( const St & state ) 
    {
     ...
     */
    template <typename St,typename StName,typename Sym>
    bool NWA<St,StName,Sym>::addFinalState( const St & state )
    {
     ...
     */
    template <typename St,typename StName,typename Sym>
    bool NWA<St,StName,Sym>::removeFinalState( const St & state )
    {
     ...
     */
    template <typename St,typename StName,typename Sym>
    bool NWA<St,StName,Sym>::addCallTrans( const St & from, const Sym & sym, const St & to )
    {
      if(! isState(from)
        || ! isState(to) )
        return false;
     ...
     */
    template <typename St,typename StName,typename Sym> 
    bool NWA<St,StName,Sym>::removeCallTrans( const St & from,const Sym & sym, const St & to )
    {
      if(! isState(from)
        || ! isState(to) )
        return false;
     ...
     */
    template <typename St,typename StName,typename Sym>
    bool NWA<St,StName,Sym>::addInternalTrans( const St & from,const Sym & sym, const St & to )
    {
      if(! isState(from)
        || ! isState(to) )
        return false;
     ...
     */
    template <typename St,typename StName,typename Sym>
    bool NWA<St,StName,Sym>::removeInternalTrans( const St & from,const Sym & sym, const St & to )
    {
      if(! isState(from)
        || ! isState(to) )
        return false;
     ...
     */
    template <typename St,typename StName,typename Sym>
    bool NWA<St,StName,Sym>::addReturnTrans( const St & from, const St & pred,const Sym & sym, const St & to )
    {
      if(! isState(from)
        || ! isState(pred)
        || ! isState(to) )
     ...
     */
    template <typename St,typename StName,typename Sym>
    bool NWA<St,StName,Sym>::removeReturnTrans( const St & from,const Sym & sym, const St & to )
    {
      if(! isState(from)
        || ! isState(to) )
        return false;
     ...
     */
    template <typename St,typename StName,typename Sym> 
    bool NWA<St,StName,Sym>::removeReturnTrans( const St & from, const St & pred,const Sym & sym, const St & to )
    {
      if(! isState(from)
        || ! isState(pred)
        || ! isState(to) )
     ...
     */
    template <typename St,typename StName,typename Sym>
    bool NWA<St,StName,Sym>::nodeIntersect( const St & node1, const St & node2, St & result )
    {
