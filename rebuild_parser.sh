...
/usr/bin/gcc -o _build64/Examples/cprover/ast.os -c -Wall -g -Wextra -Wformat=2 -Winit-self -Wunused -Wfloat-equal -Wpointer-arith -Wcast-align -Wwrite-strings -Wconversion -fdiagnostics-show-option -fPIC -DBOOST_NO_DEFAULTED_FUNCTIONS=1 -DCHECKED_LEVEL=2 -DEXPORT_GTR_SYMBOLS=0 -DPRATHMEHS_NWA_DETENSOR=0 -DREGEXP_TEST=1 -DTSL_DETENSOR=1 -D_GLIBCXX_DEBUG=1 -D__TSL_REGEXP=1 -I/home/tsl-sandbox -ISource -I$BOOST_PATH/include -IExamples/cprover -IAddOns/Domains/Source -IAddOns/Domains/ThirdParty/include Examples/cprover/ast.c || exit 1

/usr/bin/g++ -o _build64/Examples/cprover/BplToPds.os -c -O0 -Wall -g -Wextra -fdiagnostics-show-option -fPIC -DBOOST_NO_DEFAULTED_FUNCTIONS=1 -DCHECKED_LEVEL=2 -DEXPORT_GTR_SYMBOLS=0 -DPRATHMEHS_NWA_DETENSOR=0 -DREGEXP_TEST=1 -DTSL_DETENSOR=1 -D_GLIBCXX_DEBUG=1 -D__TSL_REGEXP=1 -I/home/tsl-sandbox -ISource -I$BOOST_PATH/include -IExamples/cprover -IAddOns/Domains/Source -IAddOns/Domains/ThirdParty/include Examples/cprover/BplToPds.cpp || exit 1

echo "***************** Link phase: *****************"
/usr/bin/g++ -o _build64/Examples/cprover/libbpparser.so -rdynamic -shared -Wl,-rpath=$BOOST_PATH/lib -Wl,-rpath=/home/turetsky/OCamlTest -Wl,-rpath=/home/turetsky/WALi-OpenNWA/lib64 _build64/Examples/cprover/bp_parser.os _build64/Examples/cprover/bp_scanner.os _build64/Examples/cprover/BplToPds.os _build64/Examples/cprover/ast.os -L$BOOST_PATH/lib -L/home/turetsky/OCamlTest -Llib64 -lboost_filesystem -lboost_system -lboost_serialization -lrt -ldl -lm -lwali || exit 1
