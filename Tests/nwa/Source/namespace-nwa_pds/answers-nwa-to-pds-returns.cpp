...
std::string answers_forwards_returns[] = {
    //NWA 0
    ""
    ,
    ...
    //NWA 2
    "<(program,(q0sr,(q0sr,q2sr))), q2sr> -> <program, q2sr>\tONE\n"
    ...
    "<(program,(q2sr,(q0sr,q2sr))), q2sr> -> <program, q2sr>\tONE\n"
    ...
    "<program, q0sr> -> <program, q1sr q2sr>\tONE\n"
