    ...
    namespace eah
    {
      ...
      class EAH
      {
        ...
        public:
           ...
           * @see EAH::init_vars
           */
          static bool initialize( int num_locks );
        ...
        private: // Helper methods
          ...
          static bool allocate( int num_locks );
          ...
          /** @return BDD var number for var [v] in ply [ply] */
          static int vn(int ply, int v);
