...
int loginBad(char *password, int password_len, char* guess, int guess_len) {
    int matches = 1;
    int tick = 0;
...
void main() {
    ...
    __VERIFIER_assert(loginBad(password1,password_len1,guess,guess_len)
		      == loginBad(password2,password_len2,guess,guess_len));
}
