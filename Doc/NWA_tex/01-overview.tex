...
\begin{description}
  ...
  \item[\texttt{NWA}] Models a nested-word automaton. To use, include
    ...
    \sectref{NWA-class}. (\sectref{serialization} also discusses a couple
...
\begin{description}
  \item[\texttt{ref\_ptr$<$T$>$}] This is a reference-counted intrusive smart
    pointer template. Defined in \texttt{wali/ref\_ptr.hpp}.
  ...
  \item[\texttt{key2str}] Is a inverse of \texttt{getKey}, except that it
    ...
    returns a copy of the original string.  Declared in
    \texttt{wali/Key.hpp}.
