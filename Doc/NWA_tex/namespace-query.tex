...
\begin{functionlist}
  \functionitemnonl[\texttt{WFA prestar( NWA const \& nwa, WFA const \& input, WeightGen \& wg )}]
  \functionitemnonl[\texttt{void prestar( NWA const \& nwa, WFA const \& input, WFA \& output, WeightGen \& wg )}]
  ...
  \functionitemnonl[\texttt{WFA poststar( NWA const \& nwa, WFA const \& input, WeightGen \& wg )}]
  \functionitemnonl[\texttt{void poststar( NWA const \& nwa, WFA const \& input, WFA \& output, WeightGen \& wg )}]
