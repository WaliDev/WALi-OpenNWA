...
\begin{functionlist}
  \functionitem[\texttt{WFA prestar( NWA const \& nwa, WFA \& input, WeightGen \& wg )}]
  \functionitem[\texttt{void prestar( NWA const \& nwa, WFA \& input, WFA \& output, WeightGen \& wg )}]
  ...
  \functionitem[\texttt{WFA poststar( NWA const \& nwa, WFA \& input, WeightGen \& wg )}]
  \functionitem[\texttt{void poststar( NWA const \& nwa, WFA \& input, WFA \& output, WeightGen \& wg )}]
