...
\begin{functionlist}
  ...
  \functionDef{NWARefPtr}{WpdsToNwa}{NWA const \& nwa, const WPDS\& pds}{}
    Converts \texttt{pds} to an NWA, either storing the result in
    \texttt{nwa} or returning it.

  \functionDefFirstEarly{WPDS}{NwaToWpdsCalls}{NWA const \& nwa, WeightGen<Client>\& wg}{}
  \functionDefEarly{WPDS}{NwaToBackwardsWpdsCalls}{NWA const \& nwa, WeightGen<Client>\& wg}{}
  \functionDefEarly{WPDS}{NwaToWpdsReturns}{NWA const \& nwa, WeightGen<Client>\& wg}{}
  \functionDef{WPDS}{NwaToBackwardsWpdsReturn}{NWA const \& nwa, WeightGen<Client>\& wg}{}
  ...
  \functionDefFirst{WPDS}{plusWPDS}{NWA const \& nwa, const WPDS\& base}{}
    ...
    NWA plus PDS'' construction from \cite[\S6]{advancedquerying}.
\end{functionlist}
