...
\begin{functionlist}
  \functionitemnonl[\texttt{void WpdsToNwa( NWA \& out, const WPDS\& pds )}] \nopagebreak
  ...
  \functionitemnonl[\texttt{WPDS NwaToWpdsCalls( NWA const \& nwa, WeightGen<Client>\& wg ) const}] \nopagebreak
  \functionitemnonl[\texttt{WPDS NwaToBackwardsWpdsCalls( NWA const \& nwa, WeightGen<Client>\& wg )}] \nopagebreak
  \functionitemnonl[\texttt{WPDS NwaToWpdsReturns( NWA const \& nwa, WeightGen<Client>\& wg ) const}] \nopagebreak
  ...
  \functionitemnonl[\texttt{WPDS plusWPDS( NWA const \& nwa, const WPDS\& base )}] \nopagebreak
