...
(This association is strongly informed by our uses of both WPDSs and NWAs in
program analysis. It is common for WPDSs to have just one state, $p$, and to
...
\begin{changebar}
For the rest of the section assume that we have a WPDS $(P, \Gamma, \Delta )$ 
...
\begin{changebar}
Given a WPDS the corresponding NWA is constructed using the following rules:
...
\ref{Fig:NWAtoPDS5} into a WPDS. The WPDS resulting from converting the WPDS
