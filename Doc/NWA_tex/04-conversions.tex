...
\begin{figure}[p]
  ...
  \label{Fig:WpdsToNwa1}
\end{figure}

For example, the NWA resulting from converting the WPDS shown in Figure
\ref{Fig:WpdsToNwa1} into an NWA is shown in Figure \ref{Fig:WpdsToNwa2}.

\begin{figure}[p]
  \centering
    \nwaimage[width=12cm]{Figures/pds-equivalent}
  \caption{The NWA resulting from converting the WPDS in Figure \ref{Fig:WpdsToNwa1} into an NWA.}
  \label{Fig:WpdsToNwa2}
\end{figure}
...
\begin{functionlist} 
  ...
  \functionitem[\texttt{sem\_elem\_t getWildWeight( \\
    ...
    meta-symbol \texttt{*}. By default, returns texttt{getOne()}.
...
\begin{figure}[htbp]
  \centering
    \nwaimage[width=12cm]{Figures/pre-pds-nwa}
  \caption{An example NWA.}
  \label{Fig:NwaToWpds1}
\end{figure}
...
shown in Figure \ref{Fig:NwaToWpds1} into a WPDS is shown in Figure
\ref{Fig:NwaToWpds4}. \\
...
\begin{figure}[htbp]
  \centering
    ...
    \end{itemize}
  \caption{The WPDS resulting from converting the NWA shown in Figure \ref{Fig:NwaToWpds1} into a WPDS.}
  \label{Fig:NwaToWpds4}
\end{figure}
...
\ref{Fig:NwaToWpds1} into a backwards flow WPDS.  The WPDS resulting from
converting the NWA shown in Figure \ref{Fig:NwaToWpds1} into a backwards flow
WPDS is shown in Figure \ref{Fig:NwaToWpds5}.  Note:
...
\noindent Consider, as an example, converting the NWA in Figure
\ref{Fig:NwaToWpds1} into a WPDS.  The WPDS resulting from converting the WPDS
shown in Figure \ref{Fig:NwaToWpds1} into a WPDS is shown in Figure
\ref{Fig:NwaToWpds2}. \\
...
\noindent Consider, as an example, converting the NWA in Figure
\ref{Fig:NwaToWpds3} into a backwards flow WPDS.  The WPDS resulting from
converting the WPDS shown in Figure \ref{Fig:NwaToWpds1} into a backwards flow
WPDS is shown in Figure \ref{Fig:NwaToWpds3}. \\
...
\begin{figure}[htbp]
  ...
  \caption{The WPDS resulting from converting the NWA shown in Figure
    \ref{Fig:NwaToWpds1} into a WPDS.}
  \label{Fig:NwaToWpds3}
\end{figure}
