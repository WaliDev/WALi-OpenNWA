...
\begin{functionlist}
  \functionitemnonl[\texttt{void NestedWord::appendInternal(Symbol s)}]
  \functionitemnonl[\texttt{void NestedWord::appendCall(Symbol s)}]
  \functionitem[\texttt{void NestedWord::appendReturn(Symbol s)}]
  ...
  \functionitem[\texttt{void NestedWord::append(Position p)}]
    Appends \texttt{p} to the word.
  \functionitemnonl[\texttt{NestedWord::const\_iterator NestedWord::begin() const}]
  \functionitem[\texttt{NestedWord::const\_iterator NestedWord::end() const}]
