...
they can also be built by performing language-theoretic operations over
component NWAs. These operations include: union, intersection, concatenation,
reversal, Kleene-star, complement, and determinize. The library supports two
interfaces to the Boolean operations.  In one, each operation returns a
\texttt{ref\_ptr<NWA>} to a freshly-built NWA.  In the other, each operation
transforms the NWA on which it was called. \\

\noindent The following operations are methods of class NWA:

\begin{description}

  \item\texttt{static ref\_ptr<NWA> unionNWA( ref\_ptr<NWA> first,
    \\ \hspace*{3.25cm} ref\_ptr<NWA> second )} \nopagebreak

    The result is the union of the NWAs \texttt{first} and \texttt{second}.
    See Section
    \ref{Se:Union}.

  \item\texttt{static ref\_ptr<NWA> intersect( ref\_ptr<NWA> first,
    \\ \hspace*{3.25cm} ref\_ptr<NWA> second )} \nopagebreak
  ...
  \item\texttt{static ref\_ptr<NWA> concat( ref\_ptr<NWA> first,
    \\ \hspace*{3.25cm} ref\_ptr<NWA> second )} \nopagebreak
  ...
  \item\texttt{static ref\_ptr<NWA> star( ref\_ptr<NWA> first )} \nopagebreak

    The result is the Kleene-Star of the NWA \texttt{first}. See Section
    \ref{Se:Star}.

  \item\texttt{static ref\_ptr<NWA> reverse( ref\_ptr<NWA> first )} \nopagebreak

    The result is the NWA which accepts the reverse of each nested word
    accepted by the NWA \texttt{first}. See Section \ref{Se:Reverse}.

  \item\texttt{static ref\_ptr<NWA> determinize( ref\_ptr<NWA> nondet )} \nopagebreak

    The result is the deterministic NWA that is equivalent to the NWA
    \texttt{nondet}.
    See Section \ref{Se:Determinize}.

  \item\texttt{static ref\_ptr<NWA> complement( ref\_ptr<NWA> first )} \nopagebreak
  ...
  \item\texttt{void unionNWA( ref\_ptr<NWA> first, ref\_ptr<NWA> second )} \nopagebreak
    ...
    Typical sequence of operations: construct A;
    A.unionNWA(B,C);
 ...
 \item\texttt{void intersect( ref\_ptr<NWA> first, ref\_ptr<NWA> second )} \nopagebreak
    ...
    \ref{Se:Intersection}.  Typical sequence of
    operations: construct A; A.intersect(B,C);
  ...
  \item\texttt{void concat( ref\_ptr<NWA> first, ref\_ptr<NWA> second )} \nopagebreak
    ...
    \ref{Se:Concatenation}.  Typical sequence of
    operations: construct A; A.concat(B,C);
  ...
  \item\texttt{void star( ref\_ptr<NWA> first )} \nopagebreak
    ...
    \ref{Se:Star}.  Typical sequence of
    operations: construct A; A.star(B);
  ...
  \item\texttt{void reverse( ref\_ptr<NWA> first )} \nopagebreak
    ...
    \ref{Se:Reverse}.  Typical sequence of
    operations: construct A; A.reverse(B);
  ...
  \item\texttt{void complement( ref\_ptr<NWA> first )} \nopagebreak
    ...
    the NWA \texttt{first}.  See Section \ref{Se:Complement}.
    Typical sequence of operations: construct A; A.complement(B);
...
i.e. $Q_1 \cap Q_2 = \emptyset$. Client information is copied directly from the
...
\begin{description}
  ...
  \item\texttt{bool stateIntersect( ref\_ptr<NWA> first, Key
    state1,\\ \hspace*{3.25cm} ref\_ptr<NWA> second,Key
    state2,\\ \hspace*{3.25cm} Key\& resSt, ref\_ptr<ClientInfo>\& resCI )}
    \nopagebreak
  ...
  \item\texttt{bool transitionIntersect( ref\_ptr<NWA> first, Key
    sym1,\\ \hspace*{3.25cm} ref\_ptr<NWA> second, Key
  ...
  \item\texttt{void intersectClientInfoInternal( \\ \hspace*{3.25cm}
    ref\_ptr<NWA> first, Key src1, Key tgt1,\\ \hspace*{3.25cm} ref\_ptr<NWA>
  ...
  \item\texttt{void intersectClientInfoCall( \\ \hspace*{3.25cm}
    ref\_ptr<NWA> first ,Key call1, Key entry1,\\ \hspace*{3.25cm}
    ref\_ptr<NWA> second, Key call2, Key entry2,\\ \hspace*{3.25cm} Key
    resSym, Key resSt )} \nopagebreak
  ...
  \item\texttt{void intersectClientInfoReturn( \\ \hspace*{1.75cm}
    ref\_ptr<NWA> first, Key exit1, Key call1, Key ret1,\\ \hspace*{1.75cm}
    ref\_ptr<NWA> second, Key exit2, Key call2, Key ret2,\\ \hspace*{1.75cm}
...
Figure \ref{Fig:Intersect4}.  Note that a state is only made final if both of
its component states were final in their respective NWAs (this can be seen in
the state 'Call\_1,Dead\_End' where 'Dead\_End' was final, but 'Call\_1' was
not).
...
Client information is copied directly from the component NWAs using the
...
\goodbreak Client information is copied directly from the component NWA (using
