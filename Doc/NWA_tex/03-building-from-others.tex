...
\begin{functionlist}
  ...
  \functionitem[\texttt{void complement( NWA \& out, NWA const \& orig, bool determinize )}]
    ...
    without determinization can easily lead to an incorrect result.)
...
\begin{figure}[p]
  \centering
    ...
    \nwaimage[width=12cm]{Figures/intersection-complex-second}}
