...
they can also be built by performing language-theoretic operations with
...
returns a \texttt{ref\_ptr} to the result.  In the other, the operation takes
...
\begin{description}
  ...
  \item\texttt{bool stateIntersect( ref\_ptr<NWA> first, Key state1,\\ 
                   \hspace*{3.25cm} ref\_ptr<NWA> second, Key state2,\\
