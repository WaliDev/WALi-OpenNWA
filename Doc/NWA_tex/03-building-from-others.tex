...
\begin{figure}[htbp]
  \centering
    \nwaimage{Figures/intersection-simple-other}
...
\begin{figure}[p]
  \centering
    \nwaimage{Figures/intersection-complex-result}
...
\begin{figure}[p]
  \centering
    \nwaimage{Figures/star-simple-result}
...
\begin{figure}[p]
  \centering
    \nwaimage{Figures/reverse-of-figure-1}
...
\item For all $q \in Q$: 
  \begin{itemize}
    ...
    \item for all $q' \in Q$, if $(q,q',\wild,q'') \in \delta_r$ then
...
\begin{figure}[p]
  \centering
    \nwaimage{Figures/determinize-result}
...
\begin{figure}[p]
  \centering
    \nwaimage{Figures/complement-of-determinize}
